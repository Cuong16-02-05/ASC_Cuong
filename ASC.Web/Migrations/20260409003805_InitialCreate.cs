    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasterDataKeys", x => x.UniqueId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UniqueId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    MasterDataKeyId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MasterDataValues", x => x.UniqueId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.UniqueId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    UniqueId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RequestedServices = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceRequests", x => x.UniqueId);
                });
